...
class GPT(nn.Module):
    ...
    def _precompute_rotary_embeddings(self, seq_len, head_dim, base=12000, device=None):
        if device is None:
    ...
    def setup_optimizer(self, unembedding_lr=0.004, embedding_lr=0.2, matrix_lr=0.02,
        ...
        param_groups = [
            dict(kind='adamw', params=lm_head_params, lr=unembedding_lr * dmodel_lr_scale, betas=adam_betas, eps=1e-10, weight_decay=0.005),
            dict(kind='adamw', params=embedding_params, lr=embedding_lr * dmodel_lr_scale, betas=adam_betas, eps=1e-10, weight_decay=0.003),
            dict(kind='adamw', params=value_embeds_params, lr=0.4 * dmodel_lr_scale, betas=adam_betas, eps=1e-10, weight_decay=0.01),
